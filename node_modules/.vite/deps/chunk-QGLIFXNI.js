...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime7.jsxs)(React8.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime7.jsxs)(React8.Fragment, {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React10.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React10.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React10.useContext(GridOverflowContext);
    const {
      className,
      children,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QGLIFXNI.js.map
