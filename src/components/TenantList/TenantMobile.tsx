      ...
      <div id="container" className="relative top-[6rem] m-2">
        ...
        <div id="content" className="relative  mt-2">
          {data.map((customer, index) => (
            <div
              key={index}
              className="bg-white w-[100%] lg:w-[100%] xl:w-[50%] 2xl:w-[50%] sm:w-full xs:w-full rounded-lg mb-4"
            >
              <div className="flex flex-row gap-4 items-center m-2 py-1">
                <div className="rounded-full bg-[#C0D9FF] flex items-center justify-center h-8 w-8 p-2">
              ...
              <div className="flex flex-row justify-between items-center">
                <button className="order-1 bg-[#01337C] text-white p-1 m-1 rounded text-sm">
                  {" "}
                  Tenant
                </button>
                <button className="order-2 h-6 w-6">
                  {" "}
                  <img src={dust} className="h-5 w-4" alt="" />
                </button>
              </div>
            </div>
          ))}
