...
const Unit = () => {
  ...
  async function getUnitData() {
    const response = await axios.get(
      `http://localhost:8080/unit/info/${unitId}`
    );
  ...
  return (
    <>
      ...
      <div className="flex flex-row bg-[#D8DFEA] gap-3 relative top-[5rem]">
        <div
          className="bg-[#EDF1F7] w-[calc(100%-25rem)]  h-[fit-content] my-4 ml-4 rounded-md"
          id="sensors"
        >
        ...
        <div
          id="unit details"
          className="bg-[#EDF1F7] w-[25rem] h-[fit-content] my-4 mr-4 rounded-md"
        >
