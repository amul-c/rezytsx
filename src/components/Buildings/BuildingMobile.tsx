            ...
            <div className=" lg:w-[100%]  2xl:w-[100%] sm:w-full xs:w-full rounded-lg w-[100%] flex justify-center">
              <table className="w-[95%] divide  -y divide-gray-200 border-separate border-spacing-y-3 md:m-4 lg:m-4 m-[10px] ">
                <tbody className="divide-y divide-gray-200">
                  {data.map((item, index) => (
                    <Link to={`/homemoreinfo/building/${item.name}/${item.id}`}>
                      {" "}
                      <tr key={index} className="bg-[white] flex flex-col p-1">
                        <div className="flex flex-row justify-between items-center">
                          ...
                          <td
                            ...
                            className="order-1 rounded-l-xl px-6 py-4 whitespace-nowrap text-sm font-sm "
                          >
                          ...
                          <td
                            ...
                            className="xl:px-6 lg:px-6 sm:px-2 xs:px-2 py-4 whitespace-nowrap text-sm flex justify-end order-2 "
                          >
                        ...
                        <td className="">
                          {" "}
                          <div className="flex flex-row gap-2 bg-[#EDF1F7] h-[2.5rem] items-center justify-center rounded w-[100%] p-2">
